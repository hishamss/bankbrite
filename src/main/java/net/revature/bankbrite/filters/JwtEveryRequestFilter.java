	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
			...
			try {
				...
				// since we configured spring security in SecurityConfigurer to be statless;
				// which means that spring will not save any info
				// about the current user; so every request the securityContextHolder will be
				// null
				...
				System.out.println("JWT Exceptions");
